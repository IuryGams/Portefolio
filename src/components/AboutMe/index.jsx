...
const AboutMe = () => {
    return(
        <Section>
            ...
            <Description>Aqui você encontrará mais informações sobre mim, o que faço e minhas habilidades atuais principalmente em termos de programação e tecnologia.</Description>
            <Content>
                <ContentText>
                    <h2>Olá Mundo! 👋🏻</h2>
                    ...
                    <p>Com o propósito de alcançar o meu sonho, dedico muitas horas estudando e praticando. Também gosto de compartilhar conteúdo relacionado ao meu aprendizando durante o meu tempo de estudo. Sinta-se à vontade para me seguir no <a href="https://github.com/IuryGams" target="blank">Linkedin</a> ou no <a href="https://www.linkedin.com/in/iury-menezes-09636429b/" target="blank">GitHub</a>, onde posto conteúdos úteis sobre desensolvimento e programação web. Confira o meu aprendizando na aba <a href="/">Meus Projetos</a>.</p>
                    <p>
